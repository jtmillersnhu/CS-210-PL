...
full_write_counter("frequency.dat")
print(f'\nApples count: {full_get_count("Apples")}')
print(f'\nApples frequency: {full_get_freq("Apples"):.2f}%\n')
full_print_list()
